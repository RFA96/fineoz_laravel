...
<html lang="en">
  <head>
	...
	<link rel="icon" href="{{asset('template/images/favicon.ico')}}" type="image/ico" />

    <title>Gentelella Alela! | </title>

    <!-- Bootstrap -->
    {{--<link href="../../public/template/vendors/bootstrap/dist/css/bootstrap.css" rel="stylesheet"/>--}}
    <link href="{{asset('template/vendors/bootstrap/dist/css/bootstrap.css')}}" rel="stylesheet"/>
    <!-- Font Awesome -->
